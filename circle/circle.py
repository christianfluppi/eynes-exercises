...
class Circle():
    ...
    def set_radius(self, radius):
        if radius <= 0:raise ValueError(f"El radio del círculo debe ser un número mayor que 0 (cero) y positivo. Radio: {radius}")
        self.radius = radius
    ...
    def __mul__(self, n):
        if n <= 0:raise ValueError("El número de multiplicación debe ser un número positivo y mayor que cero.")
